...
\hline 
\hline 
dataset1 & 0.991/0.932 & 0.996/0.922 & 0.98/0.902 & 0.988/0.911\tabularnewline
\hline 
dataset2 & 0.824/0.663 & 0.815/0.523 & 0.651/0.445 & 0.718/0.464\tabularnewline
\hline 
\end{tabular}
...
The max depth was set to 5 levels, and min number of samples required
...
\hline 
\hline 
dataset1 & 0.988/0.955 & 0.998/0.967 & 0.97/0.91 & 0.984/0.937\tabularnewline
\hline 
dataset2 & 0.825/0.713 & 0.913/0.662 & 0.548/0.381 & 0.684/0.469\tabularnewline
\hline 
\end{tabular}
